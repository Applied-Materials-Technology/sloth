 ...
 * from Dunne & Petrinic.
 */
class HyperbolicViscoplasticityStressUpdateFunction : public RadialReturnStressUpdate
{
public:
  static InputParameters validParams();

  HyperbolicViscoplasticityStressUpdateFunction(const InputParameters & parameters);
